...
def dataparser(end_date, begin_date, sort, page_number):
	...
	url = "https://www.googleapis.com/customsearch/v1?q=cool&cx=008723083481617813720%3Afdqsjldyjl4&sort=date%3Ar%3A" + begin_date + "%3A" + end_date + "&key=AIzaSyAvNuOsjiqBLcB9Q55YPxCsqStUteVu5ms"
